...
public class EntityCorpse extends Entity implements IInventory
{
	...
	public void onEntityUpdate()
	{
		...
		if (world.isRemote && !RPGConfig.scatterDrops && rand.nextFloat() < .15f)
		{
			...
			world.spawnParticle(drops.isEmpty() ? EnumParticleTypes.REDSTONE : EnumParticleTypes.VILLAGER_HAPPY, (double) x + var1, (double) y + var3, (double) z + var2, .5D, .5D, .5D);
			return;
		}
